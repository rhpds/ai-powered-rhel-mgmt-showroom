...
[source,bash,run]
----
Use both the Lightspeed MCP and the RHEL MCP servers to evaluate the postgresql database on rhel-3-{guid} for optimizations and best practices that I can use to improve performance.
----
