...
Now, you should see about a report that is informed by all of the various MCP servers that you have access to.  +
To help focus it, let’s get even more specifc on the systems and tools used.
...
[source, role="execute", subs="attributes"]
----
Are my systems being evaluated for CIS Level 1 Server compliance?
----
