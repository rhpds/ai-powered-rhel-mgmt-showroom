...
The output should show you key findings including the number of systems, a summary of operating system versions, any high risk CVEs, any advisor recommendations. +
